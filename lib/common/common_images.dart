abstract class CommonPng{
  static const String _path = 'assets/images/png/';
  static const String signIn = '${_path}sign_in.png';
  static const String signUp = '${_path}sign_up.png';
  static const String google = '${_path}google.png';
  static const String onBoardingFirst = '${_path}on_boarding_first.png';
  ...
  static const String schedulePlan = '${_path}schedule_plan.png';
  static const String plans = '${_path}plans.png';

}


abstract class CommonJpg{
...
abstract class CommonAnimation{
  static const String _path = 'assets/animation/';
  static const String loader = '${_path}loader.json';
  static const String plan = '${_path}plan.json';
  static const String plans = '${_path}plans.json';
}